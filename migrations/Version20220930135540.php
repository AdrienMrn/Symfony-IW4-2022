 ...
 */
final class Version20220930135540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nature (id INT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE pokemon (id INT NOT NULL, nature_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE statistic (id INT NOT NULL, pokemon_id INT NOT NULL, hp_max INT NOT NULL, hp_min INT NOT NULL, size VARCHAR(10) NOT NULL, weight DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_649B469C2FE71C3E ON statistic (pokemon_id)');
        ...
        $this->addSql('ALTER TABLE statistic ADD CONSTRAINT FK_649B469C2FE71C3E FOREIGN KEY (pokemon_id) REFERENCES pokemon (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE statistic DROP CONSTRAINT FK_649B469C2FE71C3E');
